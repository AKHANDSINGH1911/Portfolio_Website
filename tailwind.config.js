...
export default {
  ...
  theme: {
   ...
   float: {
    ...
    fontFamily: {
  body: ["'Inter'", "sans-serif"],               // Clean, modern body text
  heading: ["'Playfair Display'", "serif"],      // Elegant headings
  accent: ["'Pacifico'", "cursive"],             // Stylish accents (optional, for logos or signatures)
  mono: ["'Fira Code'", "monospace"],            // For code blocks or techy look
},
  },
  plugins: [],
};